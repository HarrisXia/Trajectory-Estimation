...
void get_q_from_euler_(Eigen::Quaterniond &q, const Eigen::Vector3d &e) {

    float cosPhi_2 = float(cos(e(1) / float(2.0)));
    float cosTheta_2 = float(cos(e(0) / float(2.0)));
    float cosPsi_2 = float(cos(e(2) / float(2.0)));
    float sinPhi_2 = float(sin(e(1) / float(2.0)));
    float sinTheta_2 = float(sin(e(0) / float(2.0)));
    float sinPsi_2 = float(sin(e(2) / float(2.0)));
    q.w() = cosPhi_2 * cosTheta_2 * cosPsi_2 +
            sinPhi_2 * sinTheta_2 * sinPsi_2;
    q.x() = sinPhi_2 * cosTheta_2 * cosPsi_2 -
